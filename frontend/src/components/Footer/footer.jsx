    ...
    return (
        <footer className="footer" id="contact">
                ...
                <div>
                    ...
                    <ul className="footer-links footer-contact">
                        <li>
                            ...
                            <a href="mailto:Wams2027@sasi.ac.in">Email: Wams2027@sasi.ac.in</a>
                        </li>
                        <li>
                            ...
                            <a href="tel:+919492307681">+91 8074480076</a>
                        </li>
                        <li>
            ...
            <div className="footer-bottom">
                Copyright &copy; 2027 WAMS | All Rights Reserved
            </div>
        </footer>
    )
}
